...
public:
     ...
     */
    std::map<CTxDestination, std::vector<COutput>> ListCoins(interfaces::Chain::Lock& locked_chain, bool allowWatchOnly=false) const EXCLUSIVE_LOCKS_REQUIRED(cs_wallet);
